...
export const metadata: Metadata = {
  title: "Top B.Tech Colleges & Universities - College Corridor",
  description: "Explore top B.Tech Engineering colleges in India. Evaluate admission requirements, JEE Main cutoffs, rankings, and average salary packages.",
  keywords: ["btech colleges", "btech engineering", "best engineering colleges"]
};

export default async function BTechCollegesPage() {
  // Query institutions that offer B.Tech courses
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-10">
        <div className="text-center space-y-3 max-w-xl mx-auto">
          ...
          <p className="text-slate-500 text-sm">
            Evaluate cutoffs, placement packages, and admission chances for top B.Tech colleges in India.
          </p>
        </div>
        ...
        {list.length === 0 ? (
          <Card className="border border-dashed py-12 text-center max-w-md mx-auto">
            <CardContent className="text-slate-400 text-sm">
              No engineering colleges offering B.Tech found in the database.
            </CardContent>
          </Card>
        ) : (
